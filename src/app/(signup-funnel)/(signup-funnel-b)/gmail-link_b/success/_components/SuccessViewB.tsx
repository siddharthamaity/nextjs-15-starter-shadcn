...
export function SuccessViewB() {
    ...
    return (
        <div className='relative z-10 mt-3 flex w-full flex-1 flex-col items-center px-4 pb-12 md:py-6'>
            <p className='w-full px-4 pb-2 text-center text-lg font-semibold text-white'>Step 2 of 2</p>

            <div className='mt-6 flex w-full flex-col items-center justify-center text-3xl font-bold text-white'>

            ...
            <div className='flex flex-col items-center justify-center gap-1'>
                ...
                <WhatsNext
                    ...
                    rowsInfo={[
                        ...
                        {
                            content:
                                "We'll automatically rebook your ticket at lower rates for the same tickets when we get a chance. No action needed from your end."
                        },
                        {
                            content:
                                "We'll send you a WhatsApp message from the Ascend number to notify you of the total amount saved."
                        }
                    ]}
                />
                <Link
                    href='/'
                    className='text-md mt-8 rounded-full bg-neutral-50 px-8 py-3 text-center font-semibold text-neutral-900 transition-colors hover:bg-neutral-100'>
                    Go back home
                </Link>
            </div>
        </>
